...
output = tk.Label(root, text='\n\nHello! Thanks for coming here. I am a chatbot. People say that '
      'I am a kind and approachable bot. Please tell me your name')
output.pack()
...
def cb(event):
    ...
    if(output.cget("text").contains("Name"))
...
def finisher():
    print('It was really nice talking to you and I hope that now you'\
...
print("Hi " + name + "! My name's Aayush. Let's start with our session.")
